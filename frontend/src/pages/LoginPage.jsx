          ...
          <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-8 sm:p-10">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between text-sm mt-1 mb-2">
                ...
                <a href="#" className="text-orange-500 hover:text-orange-600 font-medium transition-colors">Forgot password?</a>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full mt-2 py-3.5 px-4 bg-slate-900 hover:bg-slate-800 text-white rounded-full font-medium transition-all shadow-lg shadow-slate-900/20 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center group"
              >
                {loading ? (
            ...
            <p className="mt-8 text-center text-sm text-gray-500">
              ...
              <Link to="/register" className="text-slate-900 font-bold hover:text-orange-500 transition-colors">Create one</Link>
            </p>
          </div>
        </div>
      </div>
